...
public class Automated_testing {
    ...
    public void beforeTest() throws IOException {
        ...
        file = new FileInputStream("D:\\Q1 & Q2\\SOFTWARE TESTING MODEL LABORATORY\\testing\\src\\test\\java\\test_ng\\testing\\Book1.xlsx");
        workbook = new XSSFWorkbook(file);
        sheet = workbook.getSheetAt(0);
        loanAmount = sheet.getRow(0).getCell(0).getStringCellValue();
        extent = new ExtentReports();
        ExtentSparkReporter reporter = new ExtentSparkReporter(
            "D:\\Q1 & Q2\\SOFTWARE TESTING MODEL LABORATORY\\testing\\src\\test\\java\\test_ng\\testing\\learining\\reporter.html");
